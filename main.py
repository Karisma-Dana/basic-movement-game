...
def get_background(name):
    ...
    for i in range(WIDTH // width + 1):
        for j in range(HEGIHT // hegiht + 1):
            pos = (i * width, j*hegiht)
            tiles.append(pos)
...
def main(window):
    ...
    block_size = 96
    floor = [Block(i * block_size, HEGIHT- block_size , block_size) for i in range(-WIDTH , WIDTH * 2 )]
    ...
    while run :
        ...
        print(f"posisi x frog {player.rect.x}")
